...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(thirdTask("104.00 EU"));
        System.out.println(fourthTask("(1 - 8) – 9 / 4"));
        System.out.println(fifthTask("29/02/2000"));
        System.out.println(sixthTask("@my.ru"));
        System.out.println(seventhTask("A007"));
        eighthTask(new String[]{"first", "second", "empty"});
        ninethTask("qwerrtyuiopasdfghjklzxcvbnmmmmm");
    }
